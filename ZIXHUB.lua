...
-- Configuración
local WHITELIST_PREFIXES = {"XxL3G4CY"} -- Cambia esto según tus necesidades
...
Credits:AddLabel("SCRIPT REALIZADO EN LMR CLAN")
Credits:AddLabel("Echo por:")
Credits:AddLabel("ZIX👹")
Credits:AddLabel("MONITORIADO 24/7")
Credits:AddLabel("Gracias por usar mi scrip")
Credits:AddLabel("ZIXHUB OFICIAL")
